...
//getProducto()
            //.then( (prod) => console.log(prod) ) // = resolve --> Regresa el producto
            //.catch( (err) => console.log(err.message) ); // = reject --> Hay un error
                    //estas variables no son las mismas que arriba: producto y Error 
